...
(function() {
    ...
    function argsArray(args, start) {
        var out = [];
        var begin = start || 0;
        for (var i = begin; i < args.length; i++) out.push(args[i]);
        return out;
    }
    ...
    if (CFG.trackCalls) {
        Function.prototype.apply = function (thisArg, argsArray) {
            ...
            return _Reflect_apply(this, thisArg, argsArray == null ? [] : argsArray);
        };
        ...
        Function.prototype.call = function (thisArg) {
            try {
                var stack = shortStack();
                if (inTargetScript(stack)) {
                    var argsArr = argsArray(arguments, 1);
                    log({
                        type: 'fn_call',
                        name: this.name || 'anonymous',
            ...
            return _Reflect_apply(this, thisArg, argsArray(arguments, 1));
        };
        ...
        Function.prototype.bind = function (thisArg) {
            ...
            return _Reflect_apply(_FP_bind, this, argsArray(arguments, 0));
        };
    }
